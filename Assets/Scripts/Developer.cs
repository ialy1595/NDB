...
public class Developer : MonoBehaviour {
    ...
    [HideInInspector] public int serverLimitIncreasePerDeveloper = 2500;
    ...
    void Start()
    {
        ...
        postDatabase.Add(new Post("서버 관리팀", "Server", 0, 6, "개발자 1명당 최대 유저수 제한이 " + serverLimitIncreasePerDeveloper + "씩 증가합니다."));
