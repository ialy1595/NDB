...
public class EndInterRound : MonoBehaviour {
    ...
    public void OnClick()
    {
        ...
        //버그 있다 잡자
        if (GameManager.gm.isTutorialCleared[50] == true && (Unlockables.GetInt("Basic1Health") <= 100 && Unlockables.GetInt("Basic2Health") <= 500 && Unlockables.GetBool("UnlockBasic1_Amount10") == false))
        {
